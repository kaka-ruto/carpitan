...
ActiveRecord::Schema[7.1].define(version: 2024_06_28_225814) do
  ...
  create_table "affiliations", force: :cascade do |t|
    ...
    t.index ["business_id"], name: "index_affiliations_on_business_id"
    t.index ["politician_id"], name: "index_affiliations_on_politician_id"
  end
  ...
  add_foreign_key "affiliations", "businesses"
  add_foreign_key "affiliations", "politicians"
